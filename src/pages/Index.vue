...
<div class="w-full max-w-screen-xl relative mx-auto px-6 pt-16 pb-40 md:pb-24">
        <div class="xl:flex -mx-6">
          <div class="px-6 text-left md:text-center xl:text-left max-w-2xl md:max-w-3xl mx-auto">
            <h1 class="text-3xl sm:text-4xl md:text-5xl xl:text-4xl font-light leading-tight">CICD and DevOps <span class="sm:block text-teal-500 font-normal">持续集成，持续发布，持续部署</span></h1>
          ...
          <div class="mt-12 xl:mt-0 px-6 flex-shrink-0 hidden md:block">
            <image src="gzh15.jpg" class="border-0 mx-auto" style="width: 40rem; height: 30rem;"></image>
          </div>
        </div>
      </div>
